        ...
        for rel_1 in x[:, 1]:
            if rel_1 in self.rule2_p1:
                ...
                for body in self.rule2_p1[rel_1]:
                    ...
                    ttt2 = rtt2[0] * transt[0][0], rtt2[1] * transt[0][0], rtt2[0] * transt[1][0], rtt2[1] * transt[1][0]
                    rttt2 = ttt2[0] - ttt2[3], ttt2[1] + ttt2[2]
                    tt3 = rel3_split[0] * transt[0][0], rel3_split[1] * transt[0][0], rel3_split[0] * transt[1][0], rel3_split[1] * transt[1][0]
